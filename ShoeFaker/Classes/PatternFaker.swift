...
//  ShoeFaker
//
//  Created by Geart on 05/12/2017.
...
class PatternFaker{
    ...
    func showValuesOnScreen(sensorOutletArray: [UIView]){
        ...
        for index in 0...3 {
            leftSensorsInFloats[index] = Float(leftFootSensors[index]) / 500
            rightSensorsInFloats[index] = Float(rightFootSensors[index]) / 500
        }
        
        sensorOutletArray[4].alpha = CGFloat(leftSensorsInFloats[0])
        sensorOutletArray[5].alpha = CGFloat(leftSensorsInFloats[1])
        sensorOutletArray[6].alpha = CGFloat(leftSensorsInFloats[2])
        sensorOutletArray[7].alpha = CGFloat(leftSensorsInFloats[3])
        
        
        
        sensorOutletArray[0].alpha = CGFloat(rightSensorsInFloats[0])
        sensorOutletArray[1].alpha = CGFloat(rightSensorsInFloats[1])
        sensorOutletArray[2].alpha = CGFloat(rightSensorsInFloats[2])
        sensorOutletArray[3].alpha = CGFloat(rightSensorsInFloats[3])
    }
